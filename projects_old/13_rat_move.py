...
class RatMaze(object):
	...
	def rat_move_util(self, x, y):
		...
		if self.is_valid(x+1, y):
			self.path_followed[x+1][y] = 1
			return self.rat_move_util(x+1, y)
		elif self.is_valid(x, y+1):
			self.path_followed[x][y+1] = 1
			return self.rat_move_util(x, y+1)
		return False
